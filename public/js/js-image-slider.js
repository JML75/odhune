...
function mcImgSlider(i) {
    ...
    var I = function (a) {
      ...
      nb = function (a) {
        for (
          var c, e, b = a[d];
          b;
          c = parseInt(Math.random() * b), e = a[--b], a[b] = a[c], a[c] = e
        );
        return a;
      },
      Cb = function (a, c) {
  ...
  var c = "style",
    ...
    T = zb() < 9,
    ab = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
      navigator.userAgent
    ),
    K = function (a, b) {
      if (a) {
  ...
  var G = new L(),
    ...
    ub = function (a) {
      return (
        a[l][h]("data-autovideo") == "true" || a[h]("data-autovideo") == "true"
      );
    },
    wb = function () {
      var f;
  ...
  lb.prototype = {
    ...
    e: function (j) {
      ...
      if (a[k] != "IMG") {
        if (a[k] == "A")
          ...
          if (d) f = a[h]("data-alt") || "";
          a[h]("data-autovideo") &&
            a[l][N]("data-autovideo", a[h]("data-autovideo"));
          this.A(a[l]);
          i = 0;
        } else {
          d = a[h]("data-src");
    ...
    x: function () {
      for (
        var k = [], j = Math.round(o / a.g), i = Math.round(s / a.m), g = 0;
        g < a.m;
        g++
      )
        for (var f = 0; f < a.g; f++) {
